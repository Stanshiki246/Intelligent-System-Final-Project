...
class Checkers:
    ...
    def get_player_input(self):
        ...
        while True:
            ...
            if coord1 == "":
                ...
                print(ansi_cyan + "You have surrendered." + ansi_reset)
                exit()
    ...
    #AI movement after player movement method
    ...
    @staticmethod #Alpha Beta Pruning algorithm method
    ...
    def play(self):
        ...
        while True:
            ...
            if self.player_pieces == 0:
                ...
                if wish == "" or wish == "yes":
                    print(ansi_cyan + "Game Over" + ansi_reset)
                    exit()
